...
int main( int argc, char* args[] )
{
	...
	else
	{
		...
		else
		{
            ...
            //Character c(&gSpriteSheetTexture, (float)SCREEN_WIDTH/2, (float)SCREEN_HEIGHT/2,' ');
            Word w(&gSpriteSheetTexture, (float)SCREEN_WIDTH/2, (float)SCREEN_HEIGHT/2,"M1212$@%");
            Character c(&gSpriteSheetTexture,SCREEN_WIDTH/2,SCREEN_HEIGHT/2,'1');
